...
const footerLinks = {
  shop: [
    ...
    { name: "Protective Gear", href: "/shop/gear" },
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground mb-6 max-w-sm">
              Premium motorcycle gear for riders who demand performance, style, and safety.
              Born from the streets. Built for the track.
            </p>
