        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative aspect-square max-w-lg mx-auto">
              ...
              {/* Image */}
              <motion.div
                className="relative z-10 w-full h-full rounded-[48px] overflow-hidden border border-primary/30 bg-gradient-to-br from-primary/10 via-background/30 to-accent/10 backdrop-blur-sm p-5 ring-1 ring-primary/20"
                animate={{ y: [0, -20, 0] }}
              ...
              >
                <img
                  ...
                  className="w-full h-full object-contain rounded-[36px] bg-background/40 ring-1 ring-primary/20 shadow-2xl"
                />
              </motion.div>

              {/* Decorative Elements */}
              <div
                className="absolute top-10 right-10 w-20 h-20 border border-primary/50 rounded-full animate-spin"
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative aspect-square max-w-lg mx-auto">
              ...
              {/* Image */}
              <motion.div
                className="relative z-10 w-full h-full rounded-[40px] overflow-hidden border border-primary/30 bg-gradient-to-br from-primary/10 via-background/30 to-accent/10 backdrop-blur-sm p-6"
                animate={{ y: [0, -20, 0] }}
                transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }}
              >
                <img
                  src={heroImage}
                  alt="Futuristic motorcycle helmet with neon accents"
                  className="w-full h-full object-contain rounded-[28px] bg-background/40 drop-shadow-2xl"
                />
              </motion.div>
